  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Kas Kelas <br> Ilkom</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="catat_out.php">Catatan Pengeluaran</a>
...
<h6 class="m-0 font-weight-bold text-primary">Catat Pengeluaran:</h6>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-3">
              <label>No:</label>
              <input class="form-control form-control-sm" type="number" placeholder="Id Pengeluaran..." aria-label=".form-control-sm example" name='id' required>
              </div>
              ...
              <div class="col-sm-3">
              <label>Harga:</label>
        <input class="form-control form-control-sm" type="text" placeholder="Harga Barang..." aria-label=".form-control-sm example" name='jumlah' required>
              </div>
