...
<h6 class="m-0 font-weight-bold text-primary">Tambah Anggota:</h6>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-4">
              <label>Nim:</label>
              <input class="form-control form-control-sm" type="text" placeholder="Nim..." aria-label=".form-control-sm example" name='id' required>
              </div>
            ...
            <button type="submit" class="btn btn-primary btn-lg btn-block mt-4" name='kirim'>Kirim</button>
              ...
              <?php
               ...
               $alamat = htmlspecialchars($_POST['alamat']);
                  ...
                  $wet =mysqli_query($conn, "select * from anggota where id ='$id'");
