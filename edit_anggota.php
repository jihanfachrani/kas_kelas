      ...
      <div id="content">
        ...
        <form   method="post" name='edit'>
          <div class="row ml-5 mb-2 mt-3">
            ...
            <P><b>Nim:</b></p>
         <input class="form-control" type="text" name='id' placeholder="Nim..."  value="<?php echo $d['id']; ?>" required>
        ...
        <div class="col-md-5">
        <a href="daftar_anggota.php"><button type="button" class="btn btn-info">Back</button></a>
        </div>
        ...
        <?php
          ...
          $id= htmlspecialchars($_POST['id']);
           ...
           $alamat= htmlspecialchars($_POST['alamat']);
                             ...
                             $wet =mysqli_query($conn, "select * from anggota where id ='$id' and nama like '%".$nama."%' and alamat like '%".$alamat."%'");
