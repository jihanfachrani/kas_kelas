...
<h6 class="m-0 font-weight-bold text-primary">Setor Uang Kas:</h6>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
              <label>No:</label>
              <input class="form-control form-control-sm" type="number" placeholder="No..." aria-label=".form-control-sm example" name='id' required>
              </div>
        ...
        <input class="form-control form-control-sm" type="text" placeholder="Jumlah Uang..." aria-label=".form-control-sm example" name='jumlah' required>
              </div>
              ...
              <?php
               ...
               $insert = mysqli_query($conn, "INSERT INTO kas VALUES (
                ...
                '$date'
                  ...
                  $levelw = mysqli_query($conn, "UPDATE kas SET
                 jumlah = '$jumlah'
                 WHERE id ='".$id."'
                     ");
